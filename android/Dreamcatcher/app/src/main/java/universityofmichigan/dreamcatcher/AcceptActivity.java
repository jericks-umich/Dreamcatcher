...
/**
 * IMPORTANT: GlobalClass might not work because ActivityContext could be destroyed
 */
...
public class AcceptActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        String username = sharedPrefs.getString(String.valueOf(R.string.app_username), "NULL");
        String password = sharedPrefs.getString(String.valueOf(R.string.app_pw), "NULL");
        ...
        Log.d("UPDATE","I HAVE COMPLETED ACCEPTING THE CONNECTION");
        //requestQueue.start();
    }
